                                ...
                                NavigationLink(destination: MovieDetailView(movie: movie)) {
                                    ZStack(alignment: .bottomLeading) {
                                        if let url = movie.backdropURL {
                                            ...
                                            Rectangle().fill(LinearGradient(colors: [Color(white: 0.2), Color(white: 0.05)], startPoint: .top, endPoint: .bottom))
                                                .frame(width: UIScreen.main.bounds.width, height: 420)
                                        }
                                ...
                                NavigationLink(destination: MovieDetailView(movie: mod)) {
                                    ZStack(alignment: .bottomLeading) {
                                        if let url = mod.backdropURL {
                                            ...
                                            RoundedRectangle(cornerRadius: 16).fill(LinearGradient(colors: [Color(white: 0.2), Color(white: 0.05)], startPoint: .top, endPoint: .bottom)).frame(height: 200)
                                        }
