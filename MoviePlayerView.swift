                    ...
                    VStack(spacing:0){
                        VStack(spacing: 4) {
                            ZStack(alignment: .leading) {
                                ...
                                Capsule().fill(.white.opacity(0.7)).frame(width: max(6, (UIScreen.main.bounds.width - 68) * CGFloat(min(max(currentTime / max(duration, 1), 0), 1))), height: 6)
                            }
                        ...
                        .padding(.horizontal, 14).padding(.vertical, 😎
