                ...
                VStack{
                    HStack{
                        ...
                        HStack(spacing:6){
                            ...
                            Button{showCastSheet=true}label:{Image(systemName:"airplayvideo").font(.system(size:14)).foregroundColor(isCasting ? .blue : .white.opacity(0.8)).padding(8).background(Circle().fill(isCasting ? Color.blue.opacity(0.3) : .ultraThinMaterial.opacity(0.25))).overlay(Circle().stroke(isCasting ? Color.blue.opacity(0.5) : Color.white.opacity(0.12),lineWidth:0.5))}
