                ...
                VStack(spacing: 0) {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        HStack(spacing: 10) {
                            ...
                            Button { showPlayer = true } label: { Label("Xem ngay", systemImage: "play.rectangle.fill").frame(maxWidth: .infinity).padding(10).background(.white.opacity(0.15)).foregroundColor(.white).clipShape(Capsule()).font(.caption).fontWeight(.bold) }
                        }
                        HStack(spacing: 10) {
