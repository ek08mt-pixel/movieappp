                ...
                VStack(spacing: 0) {
                        ...
                        ForEach(LibraryTab.allCases, id: \.self) { tab in
                            Button {
                                ...
                                Text(tab.rawValue)
                                    ...
                                    .background(selectedTab == tab ? AnyShapeStyle(Capsule().fill(.ultraThinMaterial.opacity(0.5))) : AnyShapeStyle(Color.clear))
                                    .overlay(Capsule().stroke(selectedTab == tab ? Color.white.opacity(0.2) : Color.clear, lineWidth: 0.5))
                            }
                        }
                    }
                    .padding(4)
                    ...
                    if currentMovies.isEmpty {
                        ...
                        ScrollView {
                            ...
                            }.padding(.horizontal, 16).padding(.top, 20).padding(.bottom, 100)
                        }
                    }
                }
            }
